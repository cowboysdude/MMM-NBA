 /* Magic Mirror
  ...
  Module.register("MMM-NBA", {
      ...
      getDom: function() {
          ...
          if (this.config.header === true) {
              ...
              if (this.config.logo === true) {
                  header.innerHTML = "<img class='emblem' src='modules/MMM-NBA/icons/nba.png' width=6% height=6%>   NBA Scores  " + moment().format('MM/DD/YYYY');
              } else {
          ...
          if (keys.length > 0) {
              ...
              if (scores.period_time.period_status === "Final") {
                  teamcolumn.classList.add("align-left", "status");
                  teamcolumn.innerHTML = "Final";
              } else if (scores.period_time.period_status === "Preview") {
                  teamcolumn.classList.add("align-left", "preview");
                  teamcolumn.innerHTML = "Preview";
              } else {
                  teamcolumn.classList.add("xsmall", "bright");
                  teamcolumn.innerHTML = scores.period_time.period_status + "  " + scores.period_time.game_clock;
              }
              ...
              awayTempColumn.classList.add("awayteam", "font");
              ...
              if (scores.period_time.period_value > 0) {
              ...
              homeTempColumn.classList.add("hometeam", "font");
              ...
              if (scores.period_time.period_status != "Final") {
                  ...
                  statusTempColumn.classList.add("xsmall", "dimmed", "font");
                  statusTempColumn.innerHTML = "Arena: " + scores.arena;
              ...
              if (scores.period_time.period_status === " ") {
                  venuetempColumn.classList.add("xsmall", "dimmed", "font");
      ...
      scheduleCarousel: function() {
          console.log("NBA games for today");
